...
public class AlgoritmBFS extends Algoritm {
                ...
                if (newPossibleMoves >= 2) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            new AlgoritmBFS().start(maze, newX, newY - 1, newId, sequenceNumber + 1);
                        }
                    }).start();
                ...
                if (newPossibleMoves >= 2) {
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            int newId = maze.mazeTree.setId(sequenceNumber + 1);
                            maze.mazeTree.addField(newX, newY, newId);
                            new AlgoritmBFS().start(maze, newX + 1, newY, newId, sequenceNumber + 1);
                        }
                    }).start();
